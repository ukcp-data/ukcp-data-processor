...
def get_ls1_test_prob_point_data():
    ...
    reference_files = [
        path.join(
            base_path, "data", "expected_outputs", "LS1_PDF_01_point_seasonal_1.csv"
        ),
        path.join(
            base_path, "data", "expected_outputs", "LS1_PDF_01_point_seasonal_2.csv"
        ),
    ]
...
class LS1PDFCsvTestCase(unittest.TestCase):
