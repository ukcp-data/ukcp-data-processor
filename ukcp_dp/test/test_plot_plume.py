...
def get_ls6_test_obs_point_data():
    ...
    reference_files = path.join(
        base_path, "data", "expected_outputs", "LS6_Plume_01_point_seasonal.png"
    )
...
def get_ls6_test_obs_point_small_data():
    ...
    base_path = path.abspath(path.dirname(__file__))
    reference_file = path.join(
        base_path, "data", "expected_outputs", "LS6_Plume_01_point_seasonal_s.png"
    )
...
def get_ls6_test_obs_point_large_data():
    ...
    base_path = path.abspath(path.dirname(__file__))
    reference_file = path.join(
        base_path, "data", "expected_outputs", "LS6_Plume_01_point_seasonal_l.png"
    )
...
def get_ls6_test_obs_region_data():
    ...
    reference_files = path.join(
        base_path, "data", "expected_outputs", "LS6_Plume_01_country_monthly.png"
    )
