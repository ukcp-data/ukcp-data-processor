...
VARIABLE_HEADERS = {
    "clt": [
        ...
        '\t\tclt:_Storage = "contiguous" ;',
        '\t\tclt:_Endianness = "little" ;',
    ],
    "hurs": [
    ...
    "rls": [
        ...
        '\t\trls:_Storage = "contiguous" ;',
        '\t\trls:_Endianness = "little" ;',
    ],
    "rss": [
        ...
        '\t\trss:_Storage = "contiguous" ;',
        '\t\trss:_Endianness = "little" ;',
    ],
    "sfcWind": [
