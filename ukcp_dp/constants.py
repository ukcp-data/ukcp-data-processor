...
ENSEMBLE_COLOURS = ['#B9DC0C', '#50B9A4', '#007AA9', '#E47452', '#A1A0AA']
ENSEMBLE_GREYSCALES = ['#333333', '#666666', '#000000', '#999999', '#BBBBBB']
ENSEMBLE_LOWLIGHT = '#D5D5D5'

PERCENTILE_LINE_COLOUR = '#000000'
PERCENTILE_FILL = '#EEEEEE'
